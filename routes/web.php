...
/*
Product Routes
Alll the routes for our product for frontend
*/
Route::get('/products', 'Frontend\ProductsController@index')->name('products');
Route::get('/product/{slug}', 'Frontend\ProductsPagesController@show')->name('products.show');
...
Route::group(['prefix' => 'admin'], function(){
    ...
    Route::group(['prefix' => '/products'], function(){
     ...
     Route::group(['prefix' => '/categories'], function(){
        ...
        Route::post('/caregory/edit{id}', 'Backend\CategoriesController@update')->name('admin.category.update');
